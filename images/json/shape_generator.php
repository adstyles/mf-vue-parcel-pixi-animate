...
// error_log( print_r($userID, true) );
// error_log( print_r($dede_skin_original, true) );
// error_log( print_r($arlo_skin_original, true) );
// error_log( print_r($dede_hair_original, true) );
// error_log( print_r($arlo_hair_original, true) );
// error_log( print_r($dede_skin_new, true) );
// error_log( print_r($arlo_skin_new, true) );
// error_log( print_r($dede_hair_new, true) );
// error_log( print_r($arlo_hair_new, true) );
// error_log( '** error here....');
...
function str_replace_with_sed($search_1, $replace_1, $search_2, $replace_2, $search_3, $replace_3, $search_4, $replace_4, $file_in, $userID)
{
    ...
    if (!file_exists(''.$userID.'')) {
        ...
        // error_log( 'error here....');
        // error_log( print_r($userID, true) );
        // error_log( print_r($search_1, true) );
        // error_log( print_r($replace_1, true) );
        // error_log( print_r($search_2, true) );
        // error_log( print_r($replace_2, true) );
        // error_log( print_r($search_3, true) );
        // error_log( print_r($replace_3, true) );
        // error_log( print_r($search_4, true) );
        // error_log( print_r($replace_4, true) );
        // error_log( print_r($file_in, true) );
        // error_log( print_r($userID, true) );
    }

    $file_out = $userID . '/' . $file_in;
