<template>
	<div class="tasksix">
		<h1>Task 6: Draw a woolly mammoth cave painting a bit like this one</h1>
		...
		<div class="cave-paintings-wrapper">
			...
			<div class="canvas-container">
				...
				<div class="canvas-wrapper">
					...
					<canvas ref="myCanvas" id="canvas" width=769 height=309></canvas>
				</div>
				<ul>
					<li>
		...
		<div>
			...
			<!-- <img class="savedCanvasImg" v-bind:src="savedCanvas" /> -->
		</div>
		...
		<div class="next-cta">
			...
			<router-link @click.native="saveCanvas" to="/taskseven" class="button button__disabled button-round router-link">
