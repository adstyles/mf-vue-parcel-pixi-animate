...
(function (PIXI, lib) {
    ...
    var Graphic37 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 77, loop: false });
        var instance15 = new lib.DEDE_PONYTAIL_COLOUR_SECTION_01()
            .setTransform(17, -197.8);
        var instance14 = new lib.DEDE_PONYTAIL_COLOUR_SECTION_02()
            .setTransform(176.9, -143.05);
        var instance13 = new lib.DEDE_PONYTAIL_END()
    ...
    var Graphic46 = MovieClip.extend(function (mode) {
        ...
        var instance5 = new lib.DEDE_PUPIL();
        var instance17 = new lib.DEDE_PUPIL();
        ...
        this.addTimedChild(instance15)
            ...
            .addTimedChild(instance17, 27, 23, {
                "27": {
                    x: -10.9,
                    y: -126.95
                },
    ...
    var Graphic57 = MovieClip.extend(function (mode) {
        ...
        var instance39 = new lib.DEDE_PUPIL();
        var instance38 = new lib.DEDE_PUPIL();
        var instance4 = new lib.DEDE_BROW_L();
        var instance3 = new lib.DEDE_BROW_R();
        var instance2 = new lib.DEDE_NOSE()
            .setTransform(-24.25, -100.3);
        var instance1 = new lib.DEDE_EAR_L();
        var instance17 = new Graphic54(MovieClip.SYNCHED);
        var instance16 = new lib.DEDE_PONYTAIL_COLOUR_SECTION_02();
        var instance23 = new Graphics()
        ...
        this.addTimedChild(instance13, 0, 50, {
                "0": {
                    x: 17,
                    y: -197.8
                }
            })
            .addTimedChild(instance12, 0, 19, {
                "0": {
                    x: 176.9,
                    y: -143.05
                }
            ...
            .addTimedChild(instance39, 39, 11, {
                "39": {
                    x: -12.4,
                    y: -122.45
                },
            ...
            .addTimedChild(instance38, 39, 11, {
                "39": {
                    x: -52.85,
                    y: -121.6
                },
            ...
            .addTimedChild(instance17, 19, 31, {
                "19": {
                    x: 157.65,
                    y: -114.4,
                    r: 0.349
            ...
            .addTimedChild(instance23, 21, 1)
            .addTimedChild(instance22, 21, 1)
            .addTimedChild(instance25, 22, 8)
            .addTimedChild(instance24, 22, 8)
            .addTimedChild(instance27, 30, 1)
            .addTimedChild(instance26, 30, 1)
            .addTimedChild(instance29, 31, 1)
            .addTimedChild(instance28, 31, 1)
            .addTimedChild(instance31, 32, 1)
            .addTimedChild(instance30, 32, 1)
            .addTimedChild(instance33, 33, 5)
            .addTimedChild(instance32, 33, 5)
            .addTimedChild(instance35, 38, 1)
            .addTimedChild(instance34, 38, 1)
            .addTimedChild(instance37, 39, 1)
            .addTimedChild(instance36, 39, 1)
            .addTimedChild(instance41, 40, 10)
            .addTimedChild(instance40, 40, 10);
    });
    ...
    var Graphic78 = MovieClip.extend(function (mode) {
        ...
        var instance15 = new lib.DEDE_PONYTAIL_COLOUR_SECTION_01()
            .setTransform(17, -197.8);
        var instance14 = new lib.DEDE_EAR_R()
            .setTransform(-85.25, -120.15);
        var instance13 = new Graphic74(MovieClip.SYNCHED)
            .setTransform(4.15, -0.3);
        var instance12 = new Graphic73(MovieClip.SYNCHED)
            .setTransform(-18.05, -75.4);
        var instance11 = new Graphic72(MovieClip.SYNCHED);
        var instance10 = new lib.DEDE_PUPIL();
        var instance9 = new lib.DEDE_PUPIL();
        var instance29 = new lib.DEDE_PUPIL();
        var instance28 = new lib.DEDE_PUPIL();
        var instance8 = new lib.DEDE_BROW_L();
        var instance7 = new lib.DEDE_BROW_R();
        var instance6 = new lib.DEDE_NOSE()
            .setTransform(-24.25, -100.3);
        var instance5 = new lib.DEDE_EAR_L()
            .setTransform(86.85, -120.95);
        var instance4 = new Graphic71(MovieClip.SYNCHED);
        var instance3 = new lib.DEDE_PONYTAIL_COLOUR_SECTION_02();
        var instance2 = new Graphics()
            .drawCommands(shapes.s01[244]);
        var instance1 = new Graphics()
            .drawCommands(shapes.s01[235]);
        ...
        this.addTimedChild(instance15)
            ...
            .addTimedChild(instance29, 15, 11, {
                "15": {
                    x: -12.4,
                    y: -122.45
                },
            ...
            .addTimedChild(instance28, 15, 11, {
                "15": {
                    x: -52.85,
                    y: -121.6
                },
            ...
            .addTimedChild(instance2, 0, 6)
            .addTimedChild(instance1, 0, 6)
            .addTimedChild(instance17, 6, 1)
            .addTimedChild(instance16, 6, 1)
            .addTimedChild(instance19, 7, 1)
            .addTimedChild(instance18, 7, 1)
            .addTimedChild(instance21, 8, 1)
            .addTimedChild(instance20, 8, 1)
            .addTimedChild(instance23, 9, 5)
            .addTimedChild(instance22, 9, 5)
            .addTimedChild(instance25, 14, 1)
            .addTimedChild(instance24, 14, 1)
            .addTimedChild(instance27, 15, 1)
            .addTimedChild(instance26, 15, 1)
            .addTimedChild(instance31, 16, 10)
            .addTimedChild(instance30, 16, 10);
    });
    ...
    var Graphic165 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("REPLACE_HEADSET"))
            .setTransform(-6.95, 27.35, 0.485, 0.485);
        this.addTimedChild(instance1);
    });
